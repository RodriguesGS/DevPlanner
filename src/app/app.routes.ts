...
export const routes: Routes = [
  { path: '', redirectTo: 'login', pathMatch: 'full' },
  {
    ...
    title: 'Dev Planner | Login',
  },

  {
    path: 'register',
    loadComponent: () =>
      import('./features/auth/ui/register-page/register-page.component').then(
...

  {
    ...
    loadComponent: () =>
      import(
        './features/auth/ui/forgot-password/forgot-password.component'
    ...
    children: [
      {
        ...
        loadComponent: () =>
          import(
            './features/dashboard/ui/dashboard-page/dashboard-page.component'
